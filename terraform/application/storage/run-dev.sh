...
export TF_VAR_tf_storage_account_resource_group=eun-dev-025-sts-tf
export TF_VAR_tf_storage_account_name=eundev025ststf
...
function terraform_init() {
  ...
  terraform init  \
    ...
    -backend-config="key=appstorage-terraform.tfstate"
}
