...
################## Support scripts post creation of ACR #############
# to enable admin acces for ACR

# Login to az using the rootSP
#az acr update -g eun-ppe-025-sts-global1 -n eunppe025stscontainerregistry --admin-enabled true
#az acr credential show -g eun-ppe-025-sts-global1 -n eunppe025stscontainerregistry